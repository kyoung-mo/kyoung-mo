...
### 1. [자율주행 기반 무인 배달 시스템](https://github.com/kyoung-mo/can-based-autonomous-delivery-car)
...
### 2. [대형 트럭 졸음운전 감지 · 중앙 관제 플랫폼](https://github.com/kyoung-mo/dms_functional_safety) 
...
### 3. [스마트 병동 관리 시스템](https://github.com/kyoung-mo/hospital-robot-ROS2)
...
### 4. [댐 관리·제어 시스템](https://github.com/kyoung-mo/STM32-Dam-Control-System)
> STM32 기반 댐 제어 시스템 (DHT11 / 키패드 / 서보 / I2C LCD)
- HAL 기반 DHT11 / I2C LCD / 4×4 키패드 드라이버 설계 및 디버깅
- ADC 수위 센서 기반 수문 자동 제어 로직
- UART 기반 실시간 데이터 로깅

### 5. [얼굴 인식 출입 통제 시스템](https://github.com/kyoung-mo/face-security-system)
...
### 6. [DS1302 RTC 리눅스 디바이스 드라이버](https://github.com/kyoung-mo/ds1302-linux-device-driver)
...
### 7. [ATmega128 베어메탈 엘리베이터](https://github.com/kyoung-mo/atmega128-elevator)
