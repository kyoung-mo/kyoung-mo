...
| 기간 | 활동 / 경력 | 주요 내용 |
|---|---|---|
| 2025.12 ~ 2026.07 | Intel Edge AI SW 아카데미 | Intel 9기 **반장**, 주요 프로젝트 PM 2회, STM 프로젝트 4회 |
| 2020.02 ~ 2026.02 | 강원대학교(춘천) 졸업 | 디지털회로실험 조교, 전기전자공학과 전공 동아리장 |
...
- 
### 3. [자율주행 스마트 병동 관리 시스템](https://github.com/kyoung-mo/hospital-robot-ROS2)
