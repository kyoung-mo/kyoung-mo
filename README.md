...
| 2025.02 ~ 2025.08 | 무선통신 연구실 (학부연구생) | CAN 이상탐지, Hailo 엣지 AI 최적화 |
| 2025.01 ~ 2025.02 | 동계 빅데이터 연구 인턴십 | RPi5·Hailo-8L Edge 추론 최적화    |
| 2025.09 ~ 2025.09 | 캡스톤 디자인 페스티벌 장려상 | RPi5 기반 실시간 객체탐지 CCTV   |
...
| OS / 시스템 | Linux, SocketCAN, 디바이스 드라이버, 멀티스레딩 |
